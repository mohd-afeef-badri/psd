...
## Unreleased
### Added
- New preproceeing via C++, PSD_PreProcess binary (MAJOR CHANGE).
...
- Better energy splitting included Hybrib phase-field compressibility vs tensile enery condition.

### Changed
- Moved to FreeFEM 4.6.
- Moved to PETSc 13.13.
- Moved to C++ for preprocessing.
- Chnages to GFP energydecopostion plugin 'DecompEnergy_Op', now includes compressibility history.

### Removed
- No more `FFINSTALLDIR` and `GMSH` variables during `make` and `make check`.
- No more `-nonlinear` flag.
- No more `-dynamic` flag.
- No more `-soildynamic` flag.
- No more `-quasistatic` flag.



## [1.8](https://codev-tuleap.intra.cea.fr/plugins/git/hpcseism/freefem?a=tree&hb=v1.8) - 2020-01-21
### Added
...
## [1.7](https://codev-tuleap.intra.cea.fr/plugins/git/hpcseism/freefem?a=tree&hb=v1.7) - 2019-11-08
### Added
...
| [1.7](https://codev-tuleap.intra.cea.fr/plugins/git/hpcseism/freefem?a=tree&hb=v1.7)        |aee9bfec868a70b3d9974d7692bc19f9739ab7dc |
| [1.8](https://codev-tuleap.intra.cea.fr/plugins/git/hpcseism/freefem?a=tree&hb=v1.8)        |2f26292636c7248133e31ae912ee58113de2ef71 |
