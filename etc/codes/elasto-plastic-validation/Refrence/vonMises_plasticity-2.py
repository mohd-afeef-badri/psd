...
mesh = Mesh("quater_cylinder.xml")
facets = MeshFunction("size_t", mesh, "quater_cylinder_facet_region.xml")
...
deg_u = 2
deg_stress = 2
V = VectorFunctionSpace(mesh, 'P', degree=1, dim=deg_u)
