...
#MSUB -n MPIPROC             # Number of tasks to use
#MSUB -N NODES               # Number of nodes to use
#MSUB -T 1000                # Elapsed time limit in seconds
#MSUB -q skylake             # Batch queue request
#MSUB -A dendm2s
#MSUB -m work

#MSUB -o    ./OUTFILE.o            # Standard output
#MSUB -e    ./OUTFILE_%I.e         # Error output. %I is the job id         
...
ccc_mprun /ccc/work/cont002/den/foerstee/local/bin/FreeFem++-mpi -nw Main.edp -v 0 -split SPLITNUMBER KSPPAR FFPAR
