...
set multiplot layout 2,2 columnsfirst title "{/:Bold=15 Force Calculation error}" \
...
set ylabel '% Error (Pseudo NL)'
plot 'psd-stress-based-err-pseudo-nonlinear.data' u 1:3:xtic(2) with boxes t '', '' u 1:3:3 with labels offset char 0,0.5 t ''
...
plot 'psd-varf-based-err-pseudo-nonlinear.data' u 1:3:xtic(2) with boxes t '', '' u 1:3:3 with labels offset char 0,0.5 t ''
