...
// Computing elastic constitutive (4th order) tensor considering nonlinear elasticity
// p = current effective mean stress at integration point (=I1/3 with I1, 1st stress invariant)
void HujeuxLaw::computeElastTensor(const double& p)
{
	auto K = m_param[0];
	m_mu = m_param[1];
