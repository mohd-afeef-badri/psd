...
#define MacroSetInitialGradient2D(x)  \
	d.s0.gradients[0] = mfrontPreviousStrainTensor->operator[](x)  ;  \
	d.s0.gradients[1] = mfrontPreviousStrainTensor->operator[](x+3);  \
	d.s0.gradients[2] = 0.                                 ;  \
	d.s0.gradients[3] = mfrontPreviousStrainTensor->operator[](x+6);
...
#define MacroGetInitialSress2D(x) \
	...
	mfrontStressTensor->operator[](x+2)  = d.s0.thermodynamic_forces[0];  \
                                                                              \
	mfrontStressTensor->operator[](x+3)  = d.s0.thermodynamic_forces[1];  \
	mfrontStressTensor->operator[](x+4)  = d.s0.thermodynamic_forces[1];  \
	mfrontStressTensor->operator[](x+5)  = d.s0.thermodynamic_forces[1];  \
                                                                              \
	mfrontStressTensor->operator[](x+6)  = d.s0.thermodynamic_forces[3];  \
	mfrontStressTensor->operator[](x+7)  = d.s0.thermodynamic_forces[3];  \
	mfrontStressTensor->operator[](x+8)  = d.s0.thermodynamic_forces[3];
...
/*  
    3D material Tensor Logic
            ...
            indexMtTensor  = i*84;  // 21 - components of sym. material tensor and 4 quadrature points per element 4*21= 84    
           
            //------------ row 1 - 6 components -------------------//

            mfrontMaterialTensor->operator[](indexMtTensor +0 ) = d.K[0];  //  Mt_11 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +1 ) = d.K[0];  //  Mt_11 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +2 ) = d.K[0];  //  Mt_11 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +3 ) = d.K[0];  //  Mt_11 Quadrature point 1 (4 Quad points per tetra)

            mfrontMaterialTensor->operator[](indexMtTensor +4 ) = d.K[1];  //  Mt_12 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +5 ) = d.K[1];  //  Mt_12 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +6 ) = d.K[1];  //  Mt_12 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +7 ) = d.K[1];  //  Mt_12 Quadrature point 1 (4 Quad points per tetra)

            mfrontMaterialTensor->operator[](indexMtTensor +8 ) = d.K[2];  //  Mt_13 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +9 ) = d.K[2];  //  Mt_13 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +10) = d.K[2];  //  Mt_13 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +11) = d.K[2];  //  Mt_13 Quadrature point 1 (4 Quad points per tetra)

            mfrontMaterialTensor->operator[](indexMtTensor +12) = d.K[3];  //  Mt_14 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +13) = d.K[3];  //  Mt_14 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +14) = d.K[3];  //  Mt_14 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +15) = d.K[3];  //  Mt_14 Quadrature point 1 (4 Quad points per tetra)

            mfrontMaterialTensor->operator[](indexMtTensor +16) = d.K[4];  //  Mt_15 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +17) = d.K[4];  //  Mt_15 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +18) = d.K[4];  //  Mt_15 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +19) = d.K[4];  //  Mt_15 Quadrature point 1 (4 Quad points per tetra)

            mfrontMaterialTensor->operator[](indexMtTensor +20) = d.K[5];  //  Mt_16 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +21) = d.K[5];  //  Mt_16 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +22) = d.K[5];  //  Mt_16 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +23) = d.K[5];  //  Mt_16 Quadrature point 1 (4 Quad points per tetra)


            //------------ row 2 - 5 components -------------------//


            mfrontMaterialTensor->operator[](indexMtTensor +24) = d.K[7];  //  Mt_22 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +25) = d.K[7];  //  Mt_22 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +26) = d.K[7];  //  Mt_22 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +27) = d.K[7];  //  Mt_22 Quadrature point 1 (4 Quad points per tetra)

            mfrontMaterialTensor->operator[](indexMtTensor +28) = d.K[8];  //  Mt_23 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +29) = d.K[8];  //  Mt_23 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +30) = d.K[8];  //  Mt_23 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +31) = d.K[8];  //  Mt_23 Quadrature point 1 (4 Quad points per tetra)

            mfrontMaterialTensor->operator[](indexMtTensor +32) = d.K[9];  //  Mt_24 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +33) = d.K[9];  //  Mt_24 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +34) = d.K[9];  //  Mt_24 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +35) = d.K[9];  //  Mt_24 Quadrature point 1 (4 Quad points per tetra)

            mfrontMaterialTensor->operator[](indexMtTensor +36) = d.K[10];  //  Mt_25 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +37) = d.K[10];  //  Mt_25 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +38) = d.K[10];  //  Mt_25 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +39) = d.K[10];  //  Mt_25 Quadrature point 1 (4 Quad points per tetra)

            mfrontMaterialTensor->operator[](indexMtTensor +40) = d.K[11];  //  Mt_26 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +41) = d.K[11];  //  Mt_26 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +42) = d.K[11];  //  Mt_26 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +43) = d.K[11];  //  Mt_26 Quadrature point 1 (4 Quad points per tetra)

            //------------ row 3 - 4 components -------------------//


            mfrontMaterialTensor->operator[](indexMtTensor +44) = d.K[14];  //  Mt_33 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +45) = d.K[14];  //  Mt_33 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +46) = d.K[14];  //  Mt_33 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +47) = d.K[14];  //  Mt_33 Quadrature point 1 (4 Quad points per tetra)

            mfrontMaterialTensor->operator[](indexMtTensor +48) = d.K[15];  //  Mt_34 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +49) = d.K[15];  //  Mt_34 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +50) = d.K[15];  //  Mt_34 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +51) = d.K[15];  //  Mt_34 Quadrature point 1 (4 Quad points per tetra)

            mfrontMaterialTensor->operator[](indexMtTensor +52) = d.K[16];  //  Mt_35 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +53) = d.K[16];  //  Mt_35 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +54) = d.K[16];  //  Mt_35 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +55) = d.K[16];  //  Mt_35 Quadrature point 1 (4 Quad points per tetra)

            mfrontMaterialTensor->operator[](indexMtTensor +56) = d.K[17];  //  Mt_36 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +57) = d.K[17];  //  Mt_36 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +58) = d.K[17];  //  Mt_36 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +59) = d.K[17];  //  Mt_36 Quadrature point 1 (4 Quad points per tetra)

            //------------ row 4 - 3 components -------------------//

            mfrontMaterialTensor->operator[](indexMtTensor +60) = d.K[21];  //  Mt_44 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +61) = d.K[21];  //  Mt_44 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +62) = d.K[21];  //  Mt_44 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +63) = d.K[21];  //  Mt_44 Quadrature point 1 (4 Quad points per tetra)

            mfrontMaterialTensor->operator[](indexMtTensor +64) = d.K[22];  //  Mt_45 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +65) = d.K[22];  //  Mt_45 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +66) = d.K[22];  //  Mt_45 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +67) = d.K[22];  //  Mt_45 Quadrature point 1 (4 Quad points per tetra)

            mfrontMaterialTensor->operator[](indexMtTensor +68) = d.K[23];  //  Mt_46 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +69) = d.K[23];  //  Mt_46 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +70) = d.K[23];  //  Mt_46 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +71) = d.K[23];  //  Mt_46 Quadrature point 1 (4 Quad points per tetra)


            //------------ row 5 - 2 components -------------------//

            mfrontMaterialTensor->operator[](indexMtTensor +72) = d.K[28];  //  Mt_55 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +73) = d.K[28];  //  Mt_55 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +74) = d.K[28];  //  Mt_55 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +75) = d.K[28];  //  Mt_55 Quadrature point 1 (4 Quad points per tetra)

            mfrontMaterialTensor->operator[](indexMtTensor +76) = d.K[29];  //  Mt_56 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +77) = d.K[29];  //  Mt_56 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +78) = d.K[29];  //  Mt_56 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +79) = d.K[29];  //  Mt_56 Quadrature point 1 (4 Quad points per tetra)

            //------------ row 6 - 1 component -------------------//

            mfrontMaterialTensor->operator[](indexMtTensor +80) = d.K[35];  //  Mt_66 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +81) = d.K[35];  //  Mt_66 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +82) = d.K[35];  //  Mt_66 Quadrature point 1 (4 Quad points per tetra)
            mfrontMaterialTensor->operator[](indexMtTensor +83) = d.K[35];  //  Mt_66 Quadrature point 1 (4 Quad points per tetra)
*/
