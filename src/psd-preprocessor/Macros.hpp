...
writeIt
  ...
  "// -------------------------------------------------------------------         \n" 
  "//  Inputs  : Dpointlab,  PnN, PnS, PnE, PnW                                   \n" 
  "//  Outputs : DcFlag,  iN, iS, iE, iW,  Nrank, Srank, Erank, Wrank             \n"     
  "// -------------------------------------------------------------------         \n" 
  "//  Dpointlab : is the vector of [int] contains labels of borders that         \n"
  "//              contain the double couple points.                              \n"
...
<<"                                                                           \n"
<<"                                                                           \n"  
<<"  macro GetDoubelCoupleIndicies(Dpointlab,  Wh,   DcFlag,                  \n"
<<"                                PnN,  PnS,  PnE,  PnW,                     \n"
<<"                                iN,   iS,   iE,   iW,                      \n"
