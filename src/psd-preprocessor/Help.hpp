...
if(help)
 ...
 if(dirichletconditions>=1)
  ...
  "*    Dirichlet border. If your border is labeled 1 Dlabel=[1], if you  have *\n"
 ...
 if(tractionconditions>=1)
  ...
  "*    traction border. If your borders is labeled 1 Tlabel=[1], if you  have *\n"
  "*    two traction borders 4 & 5 then  Tlabel = [4,5].                       *\n"
  "*                                                                           *\n"
  "* 2. Edit values of <<tx,ty,tz>>  that provide the  three components of the *\n"
  "*    traction.                                                              *\n" 
  "*                                                                           *\n"
  "****************************************************************************/\n"
  "							        	        \n";
